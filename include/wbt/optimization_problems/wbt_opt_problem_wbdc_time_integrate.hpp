#ifndef WBT_OPTIMIZATION_PROBLEM_WBDC_TIME_INTEGRATION_H
#define WBT_OPTIMIZATION_PROBLEM_WBDC_TIME_INTEGRATION_H
...
class WBDC_Opt_TimeIntegration: public Optimization_Problem_Main{
public:
	WBDC_Opt_TimeIntegration();
	~WBDC_Opt_TimeIntegration();	
	...
	Constraint_List 							time_integrate_constraint_list; // Time Dependent Constraint List, exists for all timesteps
